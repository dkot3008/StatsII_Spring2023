...
\vspace{3in}
	\lstinputlisting[language=R, firstline=1, lastline=22]{Answer1.R}  
	
\begin{lstlisting}[language=R]
	           D     						 p.value
	        1.347281e-01     	2.039925e-05 \end{lstlisting}
...
\lstinputlisting[language=R, firstline=23, lastline=64]{Answer1.R}  

\begin{lstlisting}[language=R]
                 			[,1]      [,2]
(Intercept) 0.2041498    0.2042993
x           	  2.7134479    2.7134300 \end{lstlisting}
