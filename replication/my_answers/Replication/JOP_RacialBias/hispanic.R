...
# use scaled distance
df <- orig %>% filter(White == 1 | Hispanic == 1) %>%
  select(fatal, White, Hispanic, Houston, King_County, Los_Angeles, Orlando,San_Jose,
