...
(RR_adj <- RR_main / bf)
1 - (1/RR_adj)
####If your asian your 20% less likely to be shot at least
round(1 - (1/RR_adj),2)
...
#resultsa <- boot(data = df,
#                  statistic = cluster.pois2,
#                  R = 30000,
#                 parallel = "multicore")
 
 
 #save(resultsa, file=here("JOP_RacialBias/data","poisson_boostrapa.RData"))
# IF DO NOT WANT TO RERUN, THIS LOADS SAVED BOOTSTRAP RESULTS ------
load(here("JOP_RacialBias/data","poisson_boostrapa.RData"))
